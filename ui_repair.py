...
def link_or_copy_dir(src, dst):
    """Safely links (via junction on Windows) or copies a directory without redundant writes."""
...
def fix_deno_windows_node_modules(ui_dir):
    """Fixes Deno's missing package links on Windows by ensuring dependencies are available."""
