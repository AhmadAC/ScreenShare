...
def setup_windows_audio():
    """Ensures Stereo Mix or virtual audio loopback endpoints are enabled and active on Windows."""
...
def set_physical_mics_muted(muted: bool):
    """Mutes or unmutes physical microphone inputs at the OS level while keeping loopback intact."""
    if sys.platform.startswith("win"):
        # On Windows, software track muting in the browser handles mic muting cleanly
        # without risking silencing WASAPI/Stereo Mix loopback devices.
        return
